<h1><span>EDYCJA PYTANIA</span></h1><br />
<?php
...
if(isset($_GET['idedytuj'])){
	...
	$lekcja = '
	<form method="post" action="index.php?id=edytuj_pytanie" enctype="multipart/form-data">
	<fieldset>
...
if (isset($_POST['submit'])){ 
	...
	$query="UPDATE pytania SET pytanie='$pytanie', odp1='$odp1', odp2='$odp2', odp3='$odp3', odp4='$odp4', prawidlowa='$prawidlowa', komentarz='$komentarz', idnauczyciela='$idnauczyciela' WHERE idpytania='$idpytania'";
	mysql_query($query);
